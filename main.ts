...
namespace hicbit {
    ...
    *	Set interface motor speed , range of -255~255, that can control turn.
    */
    //% weight=98 blockGap=50 blockId=hicbit_setMotorSpeed block="Set |port %port| motor|speed %speed|and|time(s) %time|"
    //% speed.min=-255 speed.max=255 
    ...
    */
    //% weight=97 blockGap=50 blockId=hicbit_setMotorSpeed1 block="Set motor1 speed|%speed1|and motor2|speed %speed2and|time(s) %time|"
    ...
    */
    //% weight=96 blockGap=50 blockId=hicbit_setMotorSpeed2 block="Set motor3 speed|%speed1|and motor4|speed %speed2and|time(s) %time|"
    //% speed1.min=-255 speed1.max=255
    //% speed2.min=-255 speed2.max=255
    //% time.min=0 time.max=20 
    ...
    *	Stop motor.
    */
    //% weight=95 blockGap=50 blockId=hicbit_StopMotor block="Set |port %port| motor stop"
